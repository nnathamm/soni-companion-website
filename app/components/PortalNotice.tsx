const messages: Record<string, string> = {
  ...
  device_paired: "Soni is connected. Profile settings will begin syncing automatically.",
  device_revoked: "Soni has been disconnected from this profile.",
  ...
  invalid_pairing_code: "That Soni pairing code was not recognized or has expired. Create a fresh code on Soni and try again.",
